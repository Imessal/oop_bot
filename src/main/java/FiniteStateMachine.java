...
class FiniteStateMachine{
    ...
    enum State {
        ...
        Requesting("/start", "похожие", "следующий", "покажи", "помощь", "возможные запросы", "аннотация", "скрыть"),
        ShowingSimilar("/start", "следующий", "покажи","помощь", "возможные запросы"),
        ShowingNext("/start", "похожие", "следующий", "покажи", "помощь", "возможные запросы", "аннотация", "скрыть"),
        ShowingAnnotation("/start", "похожие", "следующий", "покажи", "помощь", "возможные запросы"),
        Error("/start", "следующий", "покажи","помощь", "возможные запросы", "аннотация", "скрыть"),
        ...
        static {
            ...
            map.put("скрыть", State.BanningCurrentRequest);
        }
    }
